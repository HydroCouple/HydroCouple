  ...
  namespace Spatial
  {
    ...
    class ITINComponentDataItem : public virtual IComponentDataItem
    {
      public:
         ...
         * \param data is the input QVariant to be written.
         */
        virtual void setValue(int patchDimensionIndex, int edgeDimensionIndex,
    ...
    class IPolyhedralSurfaceComponentDataItem : public virtual IComponentDataItem
    {
      public:
         ...
         * \param data is the input multi dimensional array to be written.
         */
        virtual void setValues(int patchDimensionIndex,int edgeDimensionIndex,
                       int nodeDimensionIndex, const void *data) = 0;
