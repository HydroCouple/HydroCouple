...
namespace HydroCouple
{
	namespace Data
	{
		//! A ValueDefinition describes a value returned by the Values property and the GetValues function of the <see cref="IBaseExchangeItem"/>
		/*! 
		...
		*/
		class IVariableDefinition : public virtual IDescription
		{
			...
			//Q_PROPERTY(QVariant MissingData READ missingData)

		public:
			virtual ~IVariableDefinition(){}
...
Q_DECLARE_INTERFACE(IVariableDefinition, "HydroCouple::Data::IVariableDefinition/1.0")
