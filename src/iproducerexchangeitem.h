...
#ifndef IHPRODUCEREXCHANGEITEM_H
#define IHPRODUCEREXCHANGEITEM_H
...
namespace HydroCouple
{
	namespace Data
	{
		class IAdaptedProducerExchangeItem;
		/// <summary>
		/// An output exchange item that can deliver values from an IHModelComponent.
		/// 
		/*!
		<para>
		If an output does not provide the data in the way a consumer would like to have it the output can be adapted by an IHAdaptedProducerItem,
		...
		*/
		class IProducerExchangeItem : public virtual IComponentExchangeItem
		{
			//Q_PROPERTY(QList<IConsumerExchangeItem*> Consumers READ consumers)
			//Q_PROPERTY(QList<IAdaptedProducerExchangeItem*> AdaptedProducers READ adaptedProducers)

		public:
			virtual ~IProducerExchangeItem(){}
			...
			///</summary>
			virtual void addConsumer(IConsumerExchangeItem* const consumer) = 0;
			...
			///</summary>
			virtual bool removeConsumer(IConsumerExchangeItem* const consumer) = 0;
			...
			/// </para>
			///</summary>
			virtual QList<IAdaptedProducerExchangeItem*> adaptedProducers() const = 0;
			...
			///</summary>
			virtual void addAdaptedProducer(IAdaptedProducerExchangeItem* const adaptedProducer) = 0;
			...
			///</summary>
			virtual bool removeAdaptedProducer(IAdaptedProducerExchangeItem* const adaptedProducer) = 0;
			...
			/// </remarks>
			virtual void updateValues(IConsumerExchangeItem* const querySpecifier) = 0;
		};
	}
}

using namespace HydroCouple::Data;
Q_DECLARE_INTERFACE(IProducerExchangeItem, "HydroCouple::Data::IProducerExchangeItem/1.0")

#endif // IHPRODUCEREXCHANGEITEM_H
